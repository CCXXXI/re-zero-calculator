...
class UI(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.prt_html(
            '有任何bug/问题/建议，可以加群反馈 --> <b><font color="#642100">1011182537</font></b><br>'
        )
    ...
    def import_para(self):
        ...
        if filename:
            ...
            self.prt_html(
                f'角色数据文件已指定为<b><font color="#006000">{filename}</font></b><br>'
            )
        self.run_valid()
    ...
    def import_xzq(self):
        ...
        if filename:
            ...
            self.prt_html(
                f'心之器数据文件已指定为<b><font color="#006000">{filename}</font></b><br>'
            )
        self.run_valid()
